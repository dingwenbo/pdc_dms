...
/* 插入超管, 密码为admin */
insert into pdc_member(id, pdc_id, password, salt, name, role_id, phone, register_date) 
	values(9001, 'A000000', '691b14d79bf0fa2215f155235df5e670b64394cc', '7efbd59d9741d34f', '系统管理员', 1, '13864795216', '2016-01-01');
