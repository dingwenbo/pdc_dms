...
insert into pdc_member(id, pdc_id, password, salt, name, role_id, phone, email, register_date) 
	values(9001, 'A000000', '691b14d79bf0fa2215f155235df5e670b64394cc', '7efbd59d9741d34f', '系统管理员', 1, '13864795216', 'test@test.com', '2016-01-01');

/* 任务状态 */
insert into pdc_task_status(id, code) values(1, 'TODO');
insert into pdc_task_status(id, code) values(2, 'In Progressing');
insert into pdc_task_status(id, code) values(3, 'Pending');
insert into pdc_task_status(id, code) values(4, 'Finished');