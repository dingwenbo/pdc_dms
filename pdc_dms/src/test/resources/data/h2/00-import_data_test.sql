...
insert into pdc_project(id, code, full_name, label, parent, manager) values(2, 'Pyramide', 'Pyramide Full-name', 'Second Test project', 1, 9003);
insert into pdc_project(id, code, full_name, label, parent, manager) values(3, 'Pissaro', 'Pissaro Full-name', 'Third Test project', 1, 9003);
insert into pdc_project(id, code, full_name, label, parent, manager) values(4, 'Translation', 'Translation Full-name', 'Third Test project', 1, 9003);
...
insert into pdc_project(id, code, full_name, label, parent, manager) values(6, 'STXBRUT', 'Sextant BRUT', 'Third Test project', 5, 9004);
